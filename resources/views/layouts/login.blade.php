...
<body class="@yield('body-class')">
    ...
    <nav class="nav-collapse">
        ...
        <ul class="nav__list">
            <li class="nav__item">
                <a href="/search">
                    <svg class="nav__icon-search"><use xlink:href="{{secure_asset('icon/sprite.svg#icon-profile')}}"></use></svg>
                    search page
                </a>
            </li>
            <li class="nav__item">
                <a href="/messages">
                    <svg class="nav__icon-chat"><use xlink:href="{{secure_asset('icon/sprite.svg#icon-bubbles')}}"></use></svg>
                    chat page
                </a>
            </li>
            ...
            <li class="nav__item">
                <a href="/profile">
                    <svg class="nav__icon-profile"><use xlink:href="{{secure_asset('icon/sprite.svg#icon-profile')}}"></use></svg>
                    profile page
                </a>
            </li>
            <li class="nav__item">
            ...
            <li class="nav__item">
                <a href="/logout">
                    <svg class="nav__icon-logout"><use xlink:href="{{secure_asset('icon/sprite.svg#icon-cancel-circle')}}"></use></svg>
                    log out
                </a>
            </li>
        </ul>
